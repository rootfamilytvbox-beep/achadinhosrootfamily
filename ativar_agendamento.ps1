...
Write-Host "Configurando Robô Shopee para rodar a cada 4 horas em segundo plano..." -ForegroundColor Cyan
...
Write-Host "- Ele roda sozinho a cada 4 horas em segundo plano (invisível)." -ForegroundColor Green
